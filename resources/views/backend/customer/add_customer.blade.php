                            ...
                            <form method="post" action="{{ route('customer.store') }}" enctype="multipart/form-data">
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="firstname" class="form-label">Nombre de Tienda</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="firstname" class="form-label">Ciudad del Cliente</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="example-fileinput" class="form-label">Imagen de Perfil Cliente</label>
