                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                            <form method="post" action="{{ route('employee.update') }}" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id" value="{{ $employee->id }}" <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Editar Empleado</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="experience" class="form-select @error('experience') is-invalid @enderror" id="example-select">
                                                ...
                                                <option value="1 Año" {{ $employee->experience == '1 Año' ? 'selected' : '' }}>1 Año</option>
                                                <option value="2 Años" {{ $employee->experience == '2 Años' ? 'selected' : '' }}>2 Años</option>
                                                <option value="3 Años" {{ $employee->experience == '3 Años' ? 'selected' : '' }}>3 Años</option>
                                                <option value="4 Años" {{ $employee->experience == '4 Años' ? 'selected' : '' }}>4 Años</option>
                                                <option value="5 Años" {{ $employee->experience == '5 Años' ? 'selected' : '' }}>5 Años</option>
                                            </select>
                                            @error('experience')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="example-fileinput" class="form-label">Foto de Perfil del Empleado</label>
