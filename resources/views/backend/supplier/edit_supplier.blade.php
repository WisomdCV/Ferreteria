                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                            <form method="post" action="{{ route('supplier.update') }}" enctype="multipart/form-data">
                                ...
                                <form>
                                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Editar Proveedor</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="type" class="form-select @error('type') is-invalid @enderror" id="example-select">
                                                    ...
                                                    <option value="Nacional" {{ $supplier->type == 'Nacional' ? 'selected' : '' }}>Proveedor Nacional</option>
                                                    <option value="Internacional" {{ $supplier->type == 'Internacional' ? 'selected' : '' }}>Proveedor Internacional</option>
                                                    <option value="Mayorista" {{ $supplier->type == 'Mayorista' ? 'selected' : '' }}>Proveedor Mayorista</option>
                                                </select>
                                                @error('type')
                                                <span class="text-danger"> {{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="example-fileinput" class="form-label">Imagen del Proveedor</label>
