            ...
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <div class="text-start mt-3">
                        ...
                        <p class="text-muted mb-2 font-13"><strong>Usuario :</strong> <span class="ms-2">{{ $adminData->name }}</span></p>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                    <div class="mb-3">
                                            <label for="example-fileinput" class="form-label">Imagen de Perfil Administrador</label>
